...
keywords: 
  ...
  - extreme heat
  - sports
description: The Sports Heat Tool is a free web application that provides personalized recommendations to mitigate heat stress risk during physical activity.
...
<div class="img-center" style={{"margin-bottom":"20px"}}> ![Sports Heat Policy](./img/sma-heat-policy.png)</div>
...
<div class="img-center" style={{"margin-bottom":"20px"}}> ![Sports Heat Tool](./img/sma-app.png)</div>
