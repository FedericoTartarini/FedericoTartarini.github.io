...
description: This page summarises how I like to communicate on Slack, Teams, and similar chat apps
last_update:
  author: Federico Tartarini
---

# How to communicate with me on Slack, Teams, and similar chat apps
...
The specific examples below reference Slack, since that's the tool I use most, but the same principles apply equally to Microsoft Teams, Google Chat, or whichever chat app a project uses — channels, threads, and reactions all have a direct equivalent in Teams.

:::info

## What is chat etiquette?

Chat etiquette is a code of behavior that helps the preservation of workspace boundaries.
It promotes a harmonious and comfortable baseline for communication.
It also maximizes the vast features that these tools offer.
...
Given the asynchronous nature of chat apps, messages that don't paint the whole picture lead to confusion.
...
[Slack threads](https://m.io/blog/slack-threads/) (or Teams' equivalent replies-in-conversation) enable users to reply directly to topics and messages that pertain to them.
...
Be wary of approaching chat apps with the same mentality as you might other instant messengers.
...
## What should you not do on chat apps?

As well as following the three do's above, it's just as important to avoid some common behaviors.
...
Tag me or the relevant person directly if you need a response from them.
...
In the same respect, you can use reacjis (reaction emojis) as signs of approval or disapproval.
There's little need to send messages like "okay" or "great" when you agree with something.
A well-timed 👍 or ✅ often gets the point across just as clearly, with far less noise in the channel.
