...
**[View My Website](https://federicotartarini.github.io)**

This website was created using [Resume](https://startbootstrap.com/template-overviews/resume/). Which is a resume and CV theme for [Bootstrap](http://getbootstrap.com/) created by [Start Bootstrap](http://startbootstrap.com/). This theme features a fixed sidebar with content sections to build a simple, yet elegant resume.
